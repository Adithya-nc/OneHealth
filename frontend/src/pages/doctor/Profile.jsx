  ...
  return (
    ...
    >
      ...
      <motion.div variants={itemVariants}>
        <GlassCard className="p-0 overflow-hidden relative border-0 shadow-lg">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          ...
          <motion.div variants={itemVariants}>
            <GlassCard className="p-6 bg-gradient-to-br from-blue-50/50 to-indigo-50/50 dark:from-blue-900/10 dark:to-indigo-900/10 border-blue-100 dark:border-blue-900/30">
